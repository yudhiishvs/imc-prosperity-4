...
class Trader:
    ...
    Bid value rationale:
      343468 earns ~9200/day. Extra 25% flow adds ~25% more passive fills on
      ASH (~425/day) + faster PEPPER accumulation (~200/day) ≈ 625 extra/day.
      Over 3 days ≈ 1875 total value. Bidding 2000 wins the median while
      leaving ~125 expected net gain from MAF (conservative; upside if field
      bids low). Tune MAF_BID to adjust risk/reward tradeoff.
    """

    MAF_BID = 2000   # XIRECs — change this to tune the bid
    ...
    OSMIUM_EMA_ALPHA = 0.08679 
    OSMIUM_INNER_OFFSET = 10   
    OSMIUM_OUTER_OFFSET = 6   
    OSMIUM_VOLUME_SKEW_AGGRESSION = 1.584488 
    OSMIUM_OIM_SHIFT = 1
    OSMIUM_BASE_QUOTE_SIZE = 43 
    OSMIUM_L2_QUOTE_SIZE = 35   
    OSMIUM_KILL_SWITCH_THRESHOLD = 78
    OSMIUM_OIM_THRESHOLD = 0.126732 
    OSMIUM_OIM_FADE_SCALE = 0.57325 
    OSMIUM_OIM_EDGE_SCALE = 3.4465 
    OSMIUM_OIM_TAKE_SCALE = 4.526 
    OSMIUM_FV_TETHER_SCALE = 0.06955 
