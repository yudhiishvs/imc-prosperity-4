...
class Trader:
    ...
    OSMIUM_DEV_SCALE = 6.6755          # normalization: deviation of this many ticks = "fully skewed"
    OSMIUM_DEV_POWER = 0.9415          # shape of skew curve: 1=linear, 2=quadratic, 3=cubic, etc.
