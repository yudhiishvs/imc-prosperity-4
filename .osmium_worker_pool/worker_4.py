...
class Trader:
    ...
    # Quote structure
    OSMIUM_BASE_QUOTE_SIZE = 20     # base size per side of the book

    # Price-deviation volume skew
    OSMIUM_DEV_SCALE = 6.7093          # normalization: deviation of this many ticks = "fully skewed"
    OSMIUM_DEV_POWER = 0.8752          # shape of skew curve: 1=linear, 2=quadratic, 3=cubic, etc.
    OSMIUM_UNWIND_CEILING = 1.6175     # max volume multiplier on the side moving TOWARD 10k
