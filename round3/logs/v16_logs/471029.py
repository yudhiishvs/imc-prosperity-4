...
Changes vs v14
──────────────────────────────────────────────────────────────────────────────
1. HG INSIDE-MARKET QUOTING  — The single change. HG has a consistent 16-tick
   spread (91.6% of ticks). v14 quotes at EMA±2 = mid±2, capturing only 4
   ticks per round-trip. Market bots sit at bb/ba (10001/10019 typically).
   Quoting at bb+1/ba-1 gives PRICE PRIORITY over those bots (1 tick better)
   and captures 14 ticks per round-trip — same fill frequency, 3.5× more PnL
   per fill. EMA is kept only for the trend filter and taker take-edge signal;
   it no longer sets quote prices.

All VF, options, and IV smile logic identical to v14.
"""
