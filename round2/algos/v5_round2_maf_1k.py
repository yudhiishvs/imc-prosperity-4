...
class Trader:
    ...
    MAF binary search log:
      ...
      maf4 (next):        bid=1000  → test cheap winning bid

    Analysis after 3 MAF runs:
      Trend: bid↑1000 → net PnL ↓ ~150 (expected ↓1000 if paying full bid).
      Gap (82, 215) << 1000 means run variance (~±300) swamps the MAF signal.
      Most consistent: winning at ALL three bids, paying full bid,
      flow_value F ≈ 2000-2200 XIREC/run. bid=2000 roughly breaks even (+102).
      bid=3000 and 4000 are net negative after fee.
      → Optimal: bid as low as possible while still winning.
      Decision rule for maf5:
        maf4 >> 9400  → winning at 1000, threshold < 1000; keep 1000 or try 500
        maf4 ≈ 9200   → ambiguous; try 500 or accept 1000
        maf4 << 9000  → winning at 1000 but paying too much; drop MAF
    """

    MAF_BID = 1000   # XIRECs — maf4: test cheap winning bid
