...
class Trader:
    """
    v41 — Reduce PEPPER aggressive buy ceiling from fair+10 to fair+8.
    Change from v35: max_buy_price = int(fair_value) + 8 (was +10).
    Rationale: confirmed trend — +12→+10 gave +157 PnL on official portal.
    Testing if direction continues. Risk: slower position build if market opens above fair+8.
    """
    ...
    def _trade_pepper_root(self, state: TradingState, fair_value) -> List[Order]:
        ...
        max_buy_price = int(fair_value) + 8
