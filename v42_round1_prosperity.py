...
class Trader:
    """
    v42 — Reduce PEPPER aggressive buy ceiling from fair+8 to fair+6.
    Change from v41: max_buy_price = int(fair_value) + 6 (was +8).
    Rationale: confirmed trend — +12→+10 (+157), +10→+8 (MC +77/day). Testing +8→+6.
    Risk: slower position build if market opens above fair+6.
    """
    ...
    def _trade_pepper_root(self, state: TradingState, fair_value) -> List[Order]:
        ...
        max_buy_price = int(fair_value) + 6
